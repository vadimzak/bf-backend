...
echo ""
echo "[LOCAL DEV] Exported environment variables:"
echo "   - AWS_ACCESS_KEY_ID"
echo "   - AWS_SECRET_ACCESS_KEY" 
echo "   - AWS_SESSION_TOKEN"
echo ""
echo "[LOCAL DEV] To use these credentials in your shell, run:"
echo ""
echo "   source <(apps/gamani/aws/iam/local-dev-setup.sh 2>/dev/null | grep '^export')"
echo ""
echo "Or run this script with 'eval' mode:"
echo ""
echo "   eval \"\$(apps/gamani/aws/iam/local-dev-setup.sh eval)\""
echo ""
